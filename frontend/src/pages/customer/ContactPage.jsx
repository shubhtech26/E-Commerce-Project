      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-4">
          ...
          <div className="relative pl-10">
            <MapPinIcon className="absolute left-0 top-1 h-6 w-6 text-indigo-600" />
          ...
          {/* Phone */}
          <div className="relative pl-10">
            <PhoneIcon className="absolute left-0 top-1 h-6 w-6 text-indigo-600" />
          ...
          {/* Email */}
          <div className="relative pl-10">
            <EnvelopeIcon className="absolute left-0 top-1 h-6 w-6 text-indigo-600" />
          ...
          {/* Hours */}
          <div className="relative pl-10">
            <ClockIcon className="absolute left-0 top-1 h-6 w-6 text-indigo-600" />
            <h3 className="font-semibold text-gray-900">Business Hours</h3>
            <dl className="mt-2 space-y-1 text-gray-600">
              <div>
                <dt className="inline">Weekdays: </dt>
                <dd className="inline">{contactInfo.hours.weekdays}</dd>
              </div>
              <div>
                <dt className="inline">Saturday: </dt>
                <dd className="inline">{contactInfo.hours.saturday}</dd>
              </div>
              <div>
                <dt className="inline">Sunday: </dt>
                <dd className="inline">{contactInfo.hours.sunday}</dd>
              </div>
            </dl>
          </div>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-2xl text-center">
          ...
          <div className="mt-4 flex justify-center space-x-6">
            <a href={contactInfo.social.facebook} className="text-gray-400 hover:text-gray-500">
              <span className="sr-only">Facebook</span>
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
              </svg>
            </a>
            <a href={contactInfo.social.instagram} className="text-gray-400 hover:text-gray-500">
            ...
            <a href={contactInfo.social.twitter} className="text-gray-400 hover:text-gray-500">
